...
class AppLocalizationsAr extends AppLocalizations {
  ...
  @override
  String get faqQuestion1 => 'ما هي العملة المشفرة؟';

  @override
  String get faqAnswer1 =>
      'العملة المشفرة هي أموال رقمية لامركزية، تعتمد على تقنية البلوك تشين. قد تكون على دراية بالإصدارات الأكثر شهرة، بيتكوين وإيثريوم، ولكن هناك أكثر من 5000 عملة مشفرة مختلفة متداولة.';

  @override
  String get faqQuestion2 => 'ما هو تعدين العملات المشفرة؟';

  @override
  String get faqAnswer2 =>
      'باختصار، تعدين العملات المشفرة هو مصطلح يشير إلى عملية جمع العملات المشفرة كمكافأة للعمل الذي تقوم به.';

  @override
  String get faqQuestion3 => 'كيف تعمل العملة المشفرة؟';

  @override
  String get faqAnswer3 =>
      'تعمل العملات المشفرة على دفتر أستاذ عام موزع يسمى البلوك تشين، وهو سجل لجميع المعاملات يتم تحديثه والاحتفاظ به من قبل حاملي العملة.';

  @override
  String get faqQuestion4 => 'هل العملة المشفرة آمنة؟';

  @override
  String get faqAnswer4 =>
      'عادة ما يتم بناء العملات المشفرة باستخدام تقنية البلوك تشين. تصف البلوك تشين الطريقة التي يتم بها تسجيل المعاملات في كتل ووضع طابع زمني عليها. إنها معقدة إلى حد ما، لكن النتيجة هي دفتر أستاذ رقمي يصعب العبث به.';

  @override
  String get faqQuestion5 => 'كيف يمكنني شراء العملة المشفرة؟';

  @override
  String get faqAnswer5 =>
      'يمكنك شراء العملات المشفرة من خلال البورصات أو الوسطاء أو منصات نظير إلى نظير. تأكد من استخدام منصات موثوقة وتأمين محفظتك الرقمية.';

  @override
  String get policyTermsOfService => 'شروط الخدمة';

  @override
  String get policyTermsOfServiceDesc =>
      'نحن ندعي كل السلطة لرفض أو إنهاء أو تعطيل أي مساعدة مع أو بدون سبب حسب تقدير المسؤول. هذا استضافة مستقلة تماماً.\n\n• طلبات التكوين - إذا كان لديك خادم مخصص مُدار بالكامل معنا، فإننا نقدم تكوينات PHP/MySQL المخصصة وجدران الحماية لعناوين IP المخصصة وتكوينات DNS وhttpd.\n\n• طلبات البرامج - سيتم منح تثبيت إضافة Cpanel طالما أنها لا تتعارض مع الأمان والاستقرار والأداء للمستخدمين الآخرين على الخادم.\n\n• الدعم الطارئ - لا نقدم دعماً طارئاً / دعم هاتفي / دعم الدردشة المباشرة. قد يستغرق الدعم بعض الساعات أحياناً.\n\n• النسخ الاحتياطية - نحتفظ بنسخ احتياطية لكننا لسنا مسؤولين عن فقدان البيانات، أنت المسؤول الكامل عن جميع النسخ الاحتياطية.\n\n• نحن لا ندعم أي محتوى إباحي للأطفال أو ما شابه ذلك.\n\n• لا توجد مواقع أو مواد متعلقة بالبريد العشوائي.\n\n• لا توجد مواد مضايقة قد تتسبب في انتقام الناس منك.\n\n• لا صفحات تصيد.\n\n• شبكات الروبوتات الضارة محظورة بشكل صارم.\n\n• إساءة استخدام الموارد و cronjob محظورة وستؤدي إلى التعليق أو الإنهاء.';

  @override
  String get policyCookiePolicy => 'سياسة ملفات تعريف الارتباط';

  @override
  String get policyCookiePolicyDesc =>
