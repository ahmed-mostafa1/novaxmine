...
class Data {
  ...
  Data.fromJson(dynamic json) {
    ...
    _balance = json["current_balance"].toString();
    _profitBalance = json["profit_wallet_balance"].toString();
  }
  List<Miners>? _miners;
  String? _balance;
  String? _profitBalance;

  List<Miners>? get miners => _miners;
  String? get balance => _balance;
  String? get profitBalance => _profitBalance;
...
class Miners {
  ...
  Miners.fromJson(dynamic json) {
    ...
    _coinCode = json['currency_code'].toString();
...
class ActivePlans {
  ...
  ActivePlans.fromJson(dynamic json) {
    ...
    _speedUnitText = json['speed_unit_text']?.toString();
    _maintenanceCost = json['maintenance_cost']?.toString();
  ...
  String? _speedUnitText;
  String? _maintenanceCost;
  ...
  String? get speedUnitText => _speedUnitText;
  String? get maintenanceCost => _maintenanceCost;
  ...
  Map<String, dynamic> toJson() {
    ...
    map['speed_unit_text'] = _speedUnitText;
    map['maintenance_cost'] = _maintenanceCost;
