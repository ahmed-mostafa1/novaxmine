...
class BuyPlanBottomSheet {
  ...
  static void bottomSheet(BuildContext context, int index) {
    ...
    showModalBottomSheet(
      ...
      context: context,
      builder: (context) => GetBuilder<BuyPlanController>(
        builder: (buyPlanController) => SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  ...
                  Container(
                      ...
                      decoration: BoxDecoration(color: MyColor.transparentColor, borderRadius: BorderRadius.circular(Dimensions.defaultRadius), border: Border.all(color: buyPlanController.selectPaymentSystem == MyStrings.selectOne ? MyColor.lineColor : MyColor.primaryColor, width: 1)),
                  ...
                  const CustomDivider(space: Dimensions.space15),
                  RoundedButton(
                    isLoading: buyPlanController.purchaseLoading,
                    ...
                    press: () {
                      ...
                      buyPlanController.planPurchase(planId: buyPlanController.planList[index].id ?? 0);
                    },
                  )
                ],
              ),
