          ...
          children: [
            Row(
              ...
              children: [
                MyImageWidget(
                  imageUrl:
                      "${UrlContainer.baseUrl}${controller.badgePath}/${controller.lockBadges[widget.index].image ?? ""}",
                  height: 60,
                  width: 60,
                  radius: 30,
                ),
                ...
                Expanded(
                  child: Column(
                    ...
                    children: [
                      Text(controller.lockBadges[widget.index].name ?? "",
                          style: interSemiBoldDefault.copyWith()),
                      Text(
                          "Main Earning : ${controller.achievementRepo.apiClient.getCurrencyOrUsername(isSymbol: true)}${MyConverter.formatNumber(controller.lockBadges[widget.index].earningAmount ?? '0.00')}",
              ...
              child: Column(
                children: [
                  ...
                  buildRow(
                    ...
                    value: controller
                            .lockBadges[widget.index].discountMaintenanceCost ??
                        "null",
                  ),
                  buildRow(
                    title: MyStrings.discountOnPlanPrice,
                    value:
                        controller.lockBadges[widget.index].planPriceDiscount ??
                            "null",
                  ...
                  buildRow(
                    ...
                    value: controller.lockBadges[widget.index].earningBoost ??
                        "null",
                  ),
                  buildRow(
                    title: MyStrings.enhanceReferralBonus,
                    value: controller
                            .lockBadges[widget.index].referralBonusBoost ??
                        "null",
                    isDivider: false,
                  ),
                ],
